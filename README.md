...
<p align="center">
    <a href="#">Getting Started</a> | <a href="https://github.com/oisanjaya/medius/wiki">Configuration</a> | <a href="#">Setup&nbsp;Showcase</a>
</p>
...
## Building
    ...
    `git clone https://github.com/oisanjaya/medius.git`
    `cd medius`
    `mkdir build`
    `meson setup build`
    `ninja -C build`
